...
---
### R1D13: Monday, August 10
**Today's Progress:** Continued working on the WordPress project in the course: learned about using the WP REST API and creating a custom one for providing data for the JavaScript based search function.

**Thoughts:** Getting deeper in to the possibilities of WordPress and it's not disappointing! :D
...
---
### R1D14: Tuesday, August 11
**Today's Progress:** Continued on my WordPress project, learned about sanitizing user input, and customizing the WordPress REST API.

**Thoughts:** WordPress is capable is doing way more than I thought it could!
...
---
### R1D15: Wednesday, August 12
**Today's Progress:** Added more functionality to the Wordpress project like a non-JavaScript fallback on the search function and set up user roles and permissions.

**Thoughts:** Using Members from MemberPress makes setting up roles and permissions a real breeze!
...
---
### R1D16: Thursday, August 13
**Today's Progress:** Created a private note functionality into the WordPress website, also dove in securing User Generated Content with esc_ and sanitizing_ functions.

**Thoughts:** It's hot in here! Have been working in 29 degrees Celcius!
...
---
### R1D17: Friday, August 14
**Today's Progress:** Build further on the private note functionality with custom JavaScript. Also learned to worked with Axios instead of jQuery.

**Thoughts:** Still hot, but got something done at least!
...
---
### R1D20: Monday, August 17
**Today's Progress:** Created a homepage slideshow with dynamic custom post type input and created a basic plugin.

**Thoughts:** Tomorrow I'm going to work on creating custom Blocks.
...
---
### R1D21: Tuesday, August 18
**Today's Progress:** Played around with Gutenberg Blocks and made one dynamic.

**Thoughts:** Next is cleaning up the WordPress project, it's already live on http://ronz.sgedu.site. Also want to figure out the best workflow to start a WordPress project and which starter theme I want to get to know.
...
---
### R1D22: Wednesday, August 19
**Today's Progress:** Researched the full web development stack and thought out my next steps. I will spend some time on learning UX/UI for my next project.

**Thoughts:** To be able to fully take on new web projects I also need to be able to do some prototyping, wire-framing and designing, therefor I will try Figma next.
...
---
### R1D23: Thursday, August 20
**Today's Progress:** Created my first website design in Figma.

**Thoughts:** Very intuitive tool to use! Great!
...
---
### R1D27: Monday, August 24
**Today's Progress:** Needed some extra skills on HTML/CSS so started on the Responsive Web Design Certification (300 hours) of freecodecamp.org. Did the first three chapters.

**Thoughts:** Great to do a recap of HTML/CSS, and learned some new stuff as well like cubic-bezier.
